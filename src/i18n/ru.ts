...
export const ru: I18nDictionary = {
  ...
  "vk.status_running_tool": "⏳ {tool} · действий: {count}",
  ...
  "vk.question_fallback": "❓ Вопрос",
  "vk.menu_outdated": "Это меню устарело. Запросите заново.",
  "vk.help_header": "Доступные команды:",
  "vk.new_cleared": "🆕 Сессия сброшена. Следующее сообщение начнёт новую задачу.",
  "vk.new_pick_project": "🆕 Сессия сброшена. Выбери проект для новой задачи:",
  "vk.status_report": "Проект: {project}\nСессия: {session}\nМодель: {model}\nСостояние: {state}",
  "vk.sessions_empty": "Сохранённых сессий пока нет.",
  "vk.sessions_header": "Недавние сессии — нажми, чтобы продолжить:",
  "vk.picker_total": "Всего: {total}",
  "vk.picker_total_pages": "Всего: {total} · стр. {page} из {pages}",
  "vk.session_resumed": "✅ Сессия продолжена: {title}",
  "vk.rename_usage": "Использование: /rename <новое название>",
  "vk.rename_done": "✅ Переименовано: {title}",
  ...
  "vk.run_started": "⚙️ Задача запущена. Управление кнопками ниже.",
  "vk.run_finished_empty": "✅ Задача завершена (текстового ответа нет).",
  "vk.menu_main_hint": "🏠 Главное меню.",
};
