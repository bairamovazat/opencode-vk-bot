export const en = {
  ...
  "vk.status_running_tool": "⏳ {tool} · tool actions: {count}",
  ...
  "vk.new_pick_project": "🆕 Session cleared. Pick the project for the new task:",
  ...
  "vk.picker_total_pages": "Total: {total} · page {page} of {pages}",
  ...
  "vk.run_finished_empty": "✅ Task finished (no text reply).",
