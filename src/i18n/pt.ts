...
export const pt: I18nDictionary = {
  ...
  "vk.status_running_tool": "⏳ {tool} · ações de ferramentas: {count}",
  ...
  "vk.perm_asked": "🔐 Permissão necessária: {tool}",
  "vk.perm_allowed_once": "✅ Permitido uma vez: {tool}",
  "vk.perm_allowed_always": "✅ Sempre permitido: {tool}",
  "vk.perm_rejected": "⛔ Negado: {tool}",
  "vk.q_answered": "✅ Resposta entregue ao agente.",
  "vk.question_fallback": "❓ Pergunta",
  "vk.menu_outdated": "Este menu está desatualizado. Solicite novamente.",
  "vk.help_header": "Comandos disponíveis:",
  "vk.new_cleared": "🆕 Sessão limpa. Sua próxima mensagem iniciará uma nova tarefa.",
  "vk.new_pick_project": "🆕 Sessão limpa. Escolha o projeto para a nova tarefa:",
  "vk.status_report": "Projeto: {project}\nSessão: {session}\nModelo: {model}\nEstado: {state}",
  "vk.sessions_empty": "Ainda não há sessões salvas.",
  "vk.sessions_header": "Sessões recentes — toque para retomar:",
  "vk.picker_total": "Total: {total}",
  "vk.picker_total_pages": "Total: {total} · página {page} de {pages}",
  "vk.session_resumed": "✅ Sessão retomada: {title}",
  "vk.rename_usage": "Uso: /rename <novo título>",
  "vk.rename_done": "✅ Renomeada: {title}",
  "vk.rename_no_session": "Nenhuma sessão ativa para renomear.",
  "vk.status_state_idle": "Ocioso",
  "vk.status_state_busy": "Ocupado (executando uma tarefa)",
  "vk.projects_header": "Projetos — toque para trocar:",
  "vk.project_switched": "✅ Projeto trocado: {project}",
  "vk.models_header": "Modelos — toque para trocar:",
  "vk.model_switched": "✅ Modelo trocado: {model}",
  "vk.models_empty": "Nenhum modelo disponível.",
  "vk.attachment_failed": "⚠️ Falha ao baixar {count} anexo(s).",
  "vk.run_started": "⚙️ Tarefa iniciada. Controles abaixo.",
  "vk.run_finished_empty": "✅ Tarefa concluída (sem resposta em texto).",
