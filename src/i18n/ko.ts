...
export const ko: I18nDictionary = {
  ...
  "vk.status_running_tool": "⏳ {tool} · 도구 작업: {count}",
  ...
  "vk.question_fallback": "❓ 질문",
  "vk.menu_outdated": "이 메뉴는 오래되었습니다. 다시 요청하세요.",
  "vk.help_header": "사용 가능한 명령:",
  "vk.new_cleared": "🆕 세션이 초기화되었습니다. 다음 메시지가 새 작업을 시작합니다.",
  "vk.new_pick_project": "🆕 세션이 초기화되었습니다. 새 작업의 프로젝트를 선택하세요:",
  "vk.status_report": "프로젝트: {project}\n세션: {session}\n모델: {model}\n상태: {state}",
  "vk.sessions_empty": "저장된 세션이 아직 없습니다.",
  "vk.sessions_header": "최근 세션 — 탭하여 계속하기:",
  "vk.picker_total": "총 {total}개",
  "vk.picker_total_pages": "총 {total}개 · {pages}페이지 중 {page}페이지",
  "vk.session_resumed": "✅ 세션 재개: {title}",
  "vk.rename_usage": "사용법: /rename <새 제목>",
  "vk.rename_done": "✅ 이름 변경됨: {title}",
  ...
  "vk.run_finished_empty": "✅ 작업이 완료되었습니다 (텍스트 응답 없음).",
