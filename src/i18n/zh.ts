...
export const zh: I18nDictionary = {
  ...
  "vk.status_running_tool": "⏳ {tool} · 工具操作：{count}",
  "vk.abort_done": "⏹ 任务已停止。",
  ...
  "vk.question_fallback": "❓ 问题",
  "vk.menu_outdated": "此菜单已过期，请重新请求。",
  "vk.help_header": "可用命令：",
  "vk.new_cleared": "🆕 会话已重置。你的下一条消息将开始新任务。",
  "vk.new_pick_project": "🆕 会话已重置。请选择新任务的项目：",
  "vk.status_report": "项目：{project}\n会话：{session}\n模型：{model}\n状态：{state}",
  "vk.sessions_empty": "还没有保存的会话。",
  "vk.sessions_header": "最近的会话 — 点击以继续：",
  "vk.picker_total": "共 {total} 条",
  "vk.picker_total_pages": "共 {total} 条 · 第 {page}/{pages} 页",
  "vk.session_resumed": "✅ 会话已恢复：{title}",
  "vk.rename_usage": "用法：/rename <新标题>",
  "vk.rename_done": "✅ 已重命名：{title}",
  ...
  "vk.run_finished_empty": "✅ 任务已完成（无文本回复）。",
