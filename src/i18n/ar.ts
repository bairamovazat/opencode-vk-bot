...
export const ar: I18nDictionary = {
  ...
  "vk.status_running_tool": "⏳ {tool} · إجراءات الأدوات: {count}",
  ...
  "vk.question_fallback": "❓ سؤال",
  "vk.menu_outdated": "هذه القائمة قديمة. اطلبها من جديد.",
  "vk.help_header": "الأوامر المتاحة:",
  "vk.new_cleared": "🆕 تم تصفير الجلسة. رسالتك التالية ستبدأ مهمة جديدة.",
  "vk.new_pick_project": "🆕 تم تصفير الجلسة. اختر المشروع للمهمة الجديدة:",
  "vk.status_report": "المشروع: {project}\nالجلسة: {session}\nالنموذج: {model}\nالحالة: {state}",
  "vk.sessions_empty": "لا توجد جلسات محفوظة بعد.",
  "vk.sessions_header": "جلسات حديثة — انقر للمتابعة:",
  "vk.picker_total": "الإجمالي: {total}",
  "vk.picker_total_pages": "الإجمالي: {total} · صفحة {page} من {pages}",
  "vk.session_resumed": "✅ استُؤنفت الجلسة: {title}",
  "vk.rename_usage": "الاستخدام: /rename <عنوان جديد>",
  "vk.rename_done": "✅ أُعيدت التسمية: {title}",
  ...
  "vk.run_finished_empty": "✅ اكتملت المهمة (لا يوجد رد نصي).",
