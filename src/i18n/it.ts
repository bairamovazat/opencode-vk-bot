...
export const it: I18nDictionary = {
  ...
  "vk.voice_not_configured": "🎙 Input vocale non configurato. Attiva le trascrizioni VK o imposta STT_API_URL/STT_API_KEY.",
  "vk.voice_transcribing": "🎙 Trascrizione del messaggio vocale…",
  "vk.voice_transcribe_error": "🎙 Impossibile trascrivere il messaggio vocale.",
  "vk.status_running": "⏳ L’agente sta lavorando… (azioni: {count})",
  ...
  "vk.help_header": "Comandi disponibili:",
  "vk.new_cleared": "🆕 Sessione azzerata. Il prossimo messaggio avvierà una nuova attività.",
  "vk.status_report": "Progetto: {project}\nSessione: {session}\nModello: {model}\nStato: {state}",
  "vk.sessions_empty": "Nessuna sessione salvata.",
  "vk.sessions_header": "Sessioni recenti: tocca per riprendere:",
  "vk.session_resumed": "✅ Sessione ripresa: {title}",
  "vk.rename_usage": "Uso: /rename <nuovo titolo>",
  "vk.rename_done": "✅ Rinominata: {title}",
  "vk.rename_no_session": "Nessuna sessione attiva da rinominare.",
  "vk.status_state_idle": "Inattivo",
  "vk.status_state_busy": "Occupato (attività in corso)",
  "vk.projects_header": "Progetti: tocca per cambiare:",
  "vk.project_switched": "✅ Progetto cambiato: {project}",
  "vk.models_header": "Modelli: tocca per cambiare:",
