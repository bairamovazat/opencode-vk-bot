...
export const it: I18nDictionary = {
  ...
  "vk.status_running_tool": "⏳ {tool} · azioni strumenti: {count}",
  ...
  "vk.new_pick_project": "🆕 Sessione azzerata. Scegli il progetto per la nuova attività:",
  ...
  "vk.picker_total": "Totale: {total}",
  "vk.picker_total_pages": "Totale: {total} · pagina {page} di {pages}",
  ...
  "vk.run_finished_empty": "✅ Attività completata (nessuna risposta testuale).",
