...
export const es: I18nDictionary = {
  ...
  "vk.status_running": "⏳ El agente está trabajando… (acciones: {count})",
  "vk.status_running_tool": "⏳ {tool} · acciones de herramientas: {count}",
  ...
  "vk.question_fallback": "❓ Pregunta",
  "vk.menu_outdated": "Este menú está desactualizado. Solicítalo de nuevo.",
  "vk.help_header": "Comandos disponibles:",
  "vk.new_cleared": "🆕 Sesión reiniciada. Tu próximo mensaje iniciará una nueva tarea.",
  "vk.new_pick_project": "🆕 Sesión reiniciada. Elige el proyecto para la nueva tarea:",
  "vk.status_report": "Proyecto: {project}\nSesión: {session}\nModelo: {model}\nEstado: {state}",
  "vk.sessions_empty": "Aún no hay sesiones guardadas.",
  "vk.sessions_header": "Sesiones recientes: toca para continuar:",
  "vk.picker_total": "Total: {total}",
  "vk.picker_total_pages": "Total: {total} · página {page} de {pages}",
  "vk.session_resumed": "✅ Sesión reanudada: {title}",
  "vk.rename_usage": "Uso: /rename <nuevo título>",
  "vk.rename_done": "✅ Renombrada: {title}",
  ...
  "vk.run_started": "⚙️ Tarea iniciada. Controles abajo.",
  "vk.run_finished_empty": "✅ Tarea terminada (sin respuesta de texto).",
  "vk.menu_main_hint": "🏠 Menú principal.",
};
