...
export const fr: I18nDictionary = {
  ...
  "vk.status_running_tool": "⏳ {tool} · actions d’outils : {count}",
  ...
  "vk.question_fallback": "❓ Question",
  "vk.menu_outdated": "Ce menu est obsolète. Redemandez-le.",
  "vk.help_header": "Commandes disponibles :",
  "vk.new_cleared": "🆕 Session réinitialisée. Votre prochain message lancera une nouvelle tâche.",
  "vk.new_pick_project": "🆕 Session réinitialisée. Choisis le projet pour la nouvelle tâche :",
  "vk.status_report": "Projet : {project}\nSession : {session}\nModèle : {model}\nÉtat : {state}",
  "vk.sessions_empty": "Aucune session enregistrée pour le moment.",
  "vk.sessions_header": "Sessions récentes — touchez pour reprendre :",
  "vk.picker_total": "Total : {total}",
  "vk.picker_total_pages": "Total : {total} · page {page} sur {pages}",
  "vk.session_resumed": "✅ Session reprise : {title}",
  "vk.rename_usage": "Utilisation : /rename <nouveau titre>",
  "vk.rename_done": "✅ Renommée : {title}",
  "vk.rename_no_session": "Aucune session active à renommer.",
  "vk.status_state_idle": "Inactif",
  "vk.status_state_busy": "Occupé (tâche en cours)",
  "vk.projects_header": "Projets — touchez pour changer :",
  "vk.project_switched": "✅ Projet changé : {project}",
  ...
  "vk.run_finished_empty": "✅ Tâche terminée (pas de réponse texte).",
