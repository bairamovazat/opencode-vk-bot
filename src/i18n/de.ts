...
export const de: I18nDictionary = {
  ...
  "vk.status_running_tool": "⏳ {tool} · Tool-Aktionen: {count}",
  ...
  "vk.question_fallback": "❓ Frage",
  "vk.menu_outdated": "Dieses Menü ist veraltet. Fordere es neu an.",
  "vk.help_header": "Verfügbare Befehle:",
  "vk.new_cleared": "🆕 Sitzung zurückgesetzt. Deine nächste Nachricht startet eine neue Aufgabe.",
  "vk.new_pick_project": "🆕 Sitzung zurückgesetzt. Wähle das Projekt für die neue Aufgabe:",
  "vk.status_report": "Projekt: {project}\nSitzung: {session}\nModell: {model}\nStatus: {state}",
  "vk.sessions_empty": "Noch keine gespeicherten Sitzungen.",
  "vk.sessions_header": "Letzte Sitzungen — antippen zum Fortsetzen:",
  "vk.picker_total": "Gesamt: {total}",
  "vk.picker_total_pages": "Gesamt: {total} · Seite {page} von {pages}",
  "vk.session_resumed": "✅ Sitzung fortgesetzt: {title}",
  "vk.rename_usage": "Verwendung: /rename <neuer Titel>",
  "vk.rename_done": "✅ Umbenannt: {title}",
  ...
  "vk.run_finished_empty": "✅ Aufgabe abgeschlossen (keine Textantwort).",
